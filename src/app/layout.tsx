    ...
    >
      <body className="relative min-h-full overflow-x-hidden bg-black text-white">
        ...
        <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[linear-gradient(180deg,#030407_0%,#070b12_48%,#030405_100%)]">
          <div className="absolute left-[-12%] top-[-15%] h-150 w-150 animate-liquid rounded-full bg-purple-500/20 blur-[110px]" />
          <div className="absolute bottom-[-15%] right-[-8%] h-150 w-137.5 animate-liquid-delay rounded-full bg-cyan-500/20 blur-[110px]" />
          <div className="absolute left-[35%] top-[22%] h-150 w-112.5 animate-liquid-slow rounded-full bg-pink-500/14 blur-[120px]" />
          <div className="absolute bottom-[15%] left-[2%] h-150 w-95 animate-liquid-delay rounded-full bg-indigo-500/16 blur-[100px]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.28)_72%,rgba(0,0,0,0.62)_100%)]" />
        </div>
